...
class VerifyCheckDigit(unittest.TestCase):
    def test_verify_check_digit_returns_a_tuple(self):
        ...
        self.assertIsInstance(result, tuple,
                              "verify_check_digit_should_return_tuple")
    ...
    self.assertEqual("Check Digit 3 does not match calculated value 6.", error,
                     "When passed a valid # it should return an empty string as second parameter in tuple")
    ...
    self.assertEqual("The length of the number given must be 10", error,
                     "When passed a short")  # it should return the correct error.")
    ...
    self.assertEqual(f"The first 5 characters must be A-Z, the invalid character is at {idx} is 8", error,
                     "When passed an non A-Z character in first five places throws errors.")
...
# the following definition is used to check the 6th characters values and ensure they are within the correct range.
def test_verify_check_digit_6th_character_only_be_1_2_or_3(self):
    test_value = "ABCDE42345"
    result, error = cd.verify_check_digit(test_value)
    self.assertFalse(result, "When passed an non 1, 2 or 3 character in 5 th_index it should return false")
    self.assertEqual("The sixth character must be 1 2 or 3", error,
                     "When passed a non 12 or 3 character in index 5 place returns appropriate error.")
...
# the following definition is used to check the 7th characters values and ensure they are within the correct range.
def test_verify_check_digit_7th_character_only_be_1_2_3_or_4(self):
    test_value = "ABCDE15345"
    result, error = cd.verify_check_digit(test_value)
    self.assertFalse(result, "When passed an non 1, 2 3, or 4 character in 6 th_index it should return false")

    self.assertEqual("The seventh character must be 1 2 3 or 4", error,
                     "When passed a non 1, 2, 3 or 4 character in index 6 place returns appropriate error.")
    ...
    result, error = cd.verify_check_digit(test_value)
    self.assertTrue(result, "When passed an 1, 2, 3, or 4 character in 6 th_index it should return True")
...
# the next three functions are used to determine which school you belong to.
class GetSchoolTests(unittest.TestCase):
    ...
    self.assertEqual(result, "College of Arts and Sciences",
                     "A value of 3 in index 5 should return College of Arts and Sciences")
...
if __name__ == "__main__":
    ...
    gst = GetSchoolTests()
    ggt: GetGradeTests = GetGradeTests()